...
public class ProductPreviewAdapter2 extends RecyclerView.Adapter<ProductPreviewAdapter2.ViewHolder> {
    ...
    public ProductPreviewAdapter2(List<Produit> products) {
        mProducts = products;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public ProductPreviewAdapter2.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                int viewType) {
        // create a new view
